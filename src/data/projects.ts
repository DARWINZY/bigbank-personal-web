...
export const projects: Project[] = [
  ...
  },
  {
    id: 'smte-sme-quiz',
    title: {
      th: 'แข่งตอบปัญหาวิชาการ SMTE/SME',
      en: 'SMTE/SME Academic Quiz Competition',
      lo: 'ແຂ່ງຕອບບັນຫາວິຊາການ SMTE/SME',
      zh: 'SMTE/SME 学术知识竞赛',
    },
    description: {
      th: 'ได้รับรางวัล 4th Runner-Up ในการแข่งขันตอบปัญหาวิชาการแบบทีม 3 คน ครอบคลุมองค์ความรู้ฟิสิกส์ เคมี ชีววิทยา คณิตศาสตร์ และคอมพิวเตอร์อย่างสมดุล',
      en: 'Achieved 4th Runner-Up in a team-based academic quiz (3 members) covering Physics, Chemistry, Biology, Mathematics, and Computer Science in equal proportion.',
      lo: 'ໄດ້ຮັບລາງວັນ 4th Runner-Up ໃນການແຂ່ງຂັນຕອບບັນຫາວິຊາການແບບທີມ 3 ຄົນ ຄອບຄຸມຄວາມຮູ້ຟິສິກ ເຄມີ ຊີວະວິທະຍາ ຄະນິດສາດ ແລະຄອມພິວເຕີ ຢ່າງສົມດຸນ',
      zh: '在3人团队学术知识竞赛中获得第四名，涵盖物理、化学、生物、数学和计算机科学等学科。',
    },
    image: '',
    tags: ['Physics', 'Chemistry', 'Biology', 'Math', 'CS'],
    featured: true,
    year: '2569',
    grade: {
      th: 'ม.4',
  ...
  // ── 2568 / ม.4 ──────────────────────────────────────────
  {
    id: 'math-association',
    title: {
      th: 'การสอบแข่งขันสมาคมคณิตศาสตร์แห่งประเทศไทย',
      en: 'Mathematical Association of Thailand Competition',
      lo: 'ການສອບແຂ່ງຂັນສະມາຄົມຄະນິດສາດແຫ່ງປະເທດໄທ',
      zh: '泰国数学协会竞赛',
    },
    description: {
      th: 'เข้าร่วมการสอบแข่งขันคณิตศาสตร์ที่จัดโดยสมาคมคณิตศาสตร์แห่งประเทศไทย เพื่อท้าทายความสามารถด้านการคิดวิเคราะห์เชิงตัวเลขและตรรกศาสตร์',
      en: 'Participated in the Mathematics competition organized by the Mathematical Association of Thailand, testing analytical and logical reasoning skills.',
      lo: 'ເຂົ້າຮ່ວມການສອບແຂ່ງຂັນຄະນິດສາດທີ່ຈັດໂດຍສະມາຄົມຄະນິດສາດແຫ່ງປະເທດໄທ ເພື່ອທ້າທາຍຄວາມສາມາດດ້ານການຄິດວິເຄາະເຊີງຕົວເລກ ແລະ ຕັກກະສາດ',
      zh: '参加由泰国数学协会组织的数学竞赛，检验数值分析和逻辑推理能力。',
    },
    image: '',
    tags: ['Math'],
    featured: true,
  ...
  // ── Sirindhorn (ท้ายสุด ตามที่ user ร้องขอ) ───────────
  {
